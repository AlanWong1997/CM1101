...
def normalise_input(user_input):
    ...
    spaces_removed = user_input.strip()

    # Remove punctuation and convert to lower case
    punct_removed = remove_punct(spaces_removed.lower())

    #separate words by commas
    created_list = punct_removed.split()

    filtered_words = filter_words(created_list, skip_words)
